...
public class WavCreate {
    ...
    public WavCreate(String fileName, String waveformFilename,int w, int h) throws UnsupportedAudioFileException, IOException {
            ...
            if (errStr != null) {
                ...
                if (audioInputStream != null) {
                    ...
                    if (seconds != 0) {
                        ...
                        g2.draw(new Line2D.Double(loc, 0, loc, h-INFOPAD));
                    }
                }
            }
        }
